...
export default function LocalReclamos() {
  ...
  async function enviarReclamo(e) {
    ...
    try {
      ...
      setForm({ local_id: usuario?.local_id || '', tipo: '', descripcion: '', fecha: new Date().toISOString().slice(0, 10) });
      cargarReclamos();
    } catch {
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto' }}>
      ...
      {/* Formulario */}
      {mostrarForm && (
        <form onSubmit={enviarReclamo} style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14, marginBottom: 14 }}>
            ...
            <div>
              ...
              <input
                ...
                style={inputStyle} placeholder="Ej: Faltante, Precio, Atención..."
              />
            </div>
            <div>
      ...
      {cargando ? (
        ...
        <p style={{ color: '#9090a0' }}>No tenés reclamos enviados.</p>
      ) : (
                ...
                <div style={{ borderTop: '1px solid #2d2d3d', padding: '12px 16px' }}>
                  ...
                  {r.resolucion && (
                    <div style={{ background: '#0f0f13', borderRadius: 6, padding: '10px 12px' }}>
                      ...
                      <p style={{ color: '#a0e0a0', fontSize: 13, margin: 0 }}>{r.resolucion}</p>
                    </div>
                  )}
                </div>
              )}
